namespace LurkingNinja.RandomExtensions.Algorithms
{
    ...
    /// </summary>
    public record Xoshiro128StarStar(uint S0, uint S1, uint S2, uint S3)
    {
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void Jump() => JumpCore(0x8764000b, 0xf542d2d3, 0x6fa035c3, 0x77f2db5b);
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void LongJump() => JumpCore(0xb523952e, 0x0b6f099f3, 0xccf5a0ef, 0x1c580662);

        private void JumpCore(uint j0, uint j1, uint j2, uint j3)
        {
