namespace LurkingNinja.RandomExtensions.Algorithms
{
    ...
    /// </summary>
    public record Xoshiro256StarStar(ulong S0, ulong S1, ulong S2, ulong S3)
    {
        public Xoshiro256StarStar() :
            this(1234567890123456789, 3624360693624360693, 521288629521288629, 886751238867512389) {}
        
        public ulong S0 { get; set; } = S0;
        public ulong S1 { get; set; } = S1;
        public ulong S2 { get; set; } = S2;
        public ulong S3 { get; set; } = S3;
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void Jump() => JumpCore(0x180ec6d33cfd0aba, 0xd5a61266f0c9392c, 0xa9582618e03fc9aa, 0x39abdc4529b1661c);
